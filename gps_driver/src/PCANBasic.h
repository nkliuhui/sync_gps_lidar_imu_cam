...
//
// Example:
//    f_clock = 80000000,nom_brp = 10,nom_tseg = 5,nom_tseg2 = 2,nom_sjw = 1,data_brp = 4,data_tseg1 = 7,data_tseg2 = 2,data_sjw = 1
//
...
#define TPCANTimestampFD             unsigned long long // Represents a timestamp of a received PCAN FD message
...
extern TPCANStatus CAN_Initialize(
        TPCANHandle Channel, 
...
///</remarks>
/// <example>f_clock = 80000000,nom_brp = 10,nom_tseg = 5,nom_tseg2 = 2,nom_sjw = 1,data_brp = 4,data_tseg1 = 7,data_tseg2 = 2,data_sjw = 1</example>
/// <returns>"A TPCANStatus error code"</returns>
extern TPCANStatus CAN_InitializeFD(
    TPCANHandle Channel,
...
/// <param name="Channel">"The handle of a PCAN Channel"</param>
/// <returns>"A TPCANStatus error code"</returns>
extern TPCANStatus CAN_Uninitialize(
        TPCANHandle Channel);
...
/// <param name="Channel">"The handle of a PCAN Channel"</param>
/// <returns>"A TPCANStatus error code"</returns>
extern TPCANStatus CAN_GetStatus(
        TPCANHandle Channel);
...
/// <returns>"A TPCANStatus error code"</returns>
extern TPCANStatus CAN_WriteFD(
    TPCANHandle Channel,
	TPCANMsgFD* MessageBuffer);
...
/// <returns>"A TPCANStatus error code"</returns>
extern TPCANStatus CAN_FilterMessages(
        TPCANHandle Channel, 
        DWORD FromID, 
        DWORD ToID, 
        TPCANMode Mode);
...
/// <returns>"A TPCANStatus error code"</returns>
extern TPCANStatus CAN_GetValue(
        TPCANHandle Channel, 
...
/// <param name="BufferLength">"Size in bytes of the buffer"</param>
/// <returns>"A TPCANStatus error code"</returns>
extern TPCANStatus CAN_SetValue(
        TPCANHandle Channel,
        TPCANParameter Parameter,
        void* Buffer,
		DWORD BufferLength);
...
/// <returns>"A TPCANStatus error code"</returns>
extern TPCANStatus CAN_GetErrorText(
        TPCANStatus Error, 
        WORD Language, 
        LPSTR Buffer);
